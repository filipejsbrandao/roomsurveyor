...
{
    public class RoomSurvey6 : GH_Component
    {
        public RoomSurvey6()
           : base("RoomSurvey 6", "RS6",
             "RoomSurvey version 6 - An algorithm to assist the survey of room plans using diagonals measured by the user between room corners", "RoomSurveyor", "RoomSurvey")
        {
        }
        ...
        {
            get { return new Guid("ae53fa34-e273-4e10-8fa0-743b1c353fd0"); }
        }
    }
}
