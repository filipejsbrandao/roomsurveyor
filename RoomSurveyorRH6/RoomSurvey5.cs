...
namespace RoomSurveyorRH6
{
    public class RoomSurvey5 : GH_Component
    {
        ...
        public RoomSurvey5()
          : base("RoomSurvey 5", "RS5",
            "RoomSurvey version 5 - An algorithm to assist the survey of room plans using diagonals measured by the user between room corners", "RoomSurveyor", "RoomSurvey")
        {
        }
